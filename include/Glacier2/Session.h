...
class GLACIER2_API AMI_Session_destroy : public ::Ice::AMICallbackBase
{
public:
...
class GLACIER2_API AMI_SessionControl_destroy : public ::Ice::AMICallbackBase
{
public:
...
class GLACIER2_API AMI_SessionManager_create : public ::Ice::AMICallbackBase
{
public:

    virtual void ice_response(const ::Glacier2::SessionPrx&) = 0;

    void __response(const ::Glacier2::SessionPrx& __ret)
    {
        ice_response(__ret);
    }
    void __exception(const ::Ice::Exception& ex)
...
class GLACIER2_API AMI_SSLSessionManager_create : public ::Ice::AMICallbackBase
{
public:
